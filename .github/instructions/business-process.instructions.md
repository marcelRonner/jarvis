---
applyTo: "content/business_process/**"
---

<!-- GENERATED by scripts/build_instructions.py — do not edit. Edit .claude/rules/business-process.md and run `make instructions`. -->
